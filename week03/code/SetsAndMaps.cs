...
public static class SetsAndMaps
{
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        {
            if (count2.ContainsKey(c)) count2[c]++;
            else count2[c] = 1;
        }

        return count1.Count == count2.Count && count1.All(kvp => count2.ContainsKey(kvp.Key) && count2[kvp.Key] == kvp.Value);
    }
